...
const JustForYou = ({ justForYouData }) => {
  return (
    <>
          ...
          return (
            <div className={styles.product}>
              ...
              <div className={styles.content}>
                {product.mall === true ? (
                  <div className={styles.useMall}>
                    <img
                      className={styles.mall}
                      src="https://lzd-img-global.slatic.net/g/tps/tfs/TB1iwg8eNn1gK0jSZKPXXXvUXXa-129-42.png_2200x2200q80.png_.webp"
                    />
                  </div>
                ) : (
                  <div className={styles.noMall}></div>
                )}
                <div className={styles.titleBox}>
                  {product.sale === true ? (
                    <img
                      src="https://lzd-img-global.slatic.net/us/lazgcp/76c56d8a-e7e1-4864-94e7-e8efc0eebcf6_ALL-90-36.png_2200x2200q80.png_.webp"
                      alt=""
